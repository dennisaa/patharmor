...
public: 
	...
	bool is_inter_direct_jump(void) { return edge_type_is_inter_direct_jmp(type_); }
	bool is_inter_indirect_jump(void) { return edge_type_is_inter_indirect_jmp(type_); }
